...
def parse_args():
    ...
    parse.add_argument(
            ...
            dest = 'ckpt',
            type = str,
            default = '../save/pths/model_maxmIOU50.pth',
            #default = None,
            )
    parse.add_argument(
            '--respath',
    ...
    parse.add_argument(
            ...
            dest = 'pretrain_path',
            type = str,
            default = './data/STDCNet813M_73.91.tar',
            )
    parse.add_argument(
            '--use_conv_last',
            dest = 'use_conv_last',
...
def train():
    ...
    sampler_val = torch.utils.data.SequentialSampler(dsval)
    ...
    if not args.ckpt is None:
        ...
        print('使用checkpoint'+args.ckpt)
    #net.cuda()
    net.to(device)#change
    net.train()
